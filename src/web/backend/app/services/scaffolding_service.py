    ...
    def _get_agent_definitions(
        ...
        return {
            ...
            "orchestration": {
                ...
                "workflow_phases": [
                    "Phase 1: Planning & Design (PO → RE → UX → Architects)",
                    "Phase 2: Development + ALL Tests (Code → UT → INT → API → E2E → Run All)",
                    "Phase 3: Architect Review (ALL architects must approve)",
                    "Phase 4: Rework (if ANY architect requests changes) → Loop to Phase 3",
                    "Phase 5: Testing Execution (QA + E2E + Visual) - STRICT MODE: warnings=errors",
                    "Phase 6: Final Approval (Lead Architect + QA Lead)",
                    "Phase 7: Next Wave/Phase",
                ],
                "iterative_loops": [
                    "LOOP 1: Phase 2 → 3 → 4 → 3 (until ALL architects approve)",
                    "LOOP 2: Phase 5 FAIL → Phase 2 → 3 → 4 → 5 (until ALL E2E pass)",
                ],
                "critical_rules": [
                    "Update status.md at START and END of every phase/sub-phase",
                    "ALL architects must approve before Phase 5",
                    "E2E STRICT MODE: All warnings are errors",
