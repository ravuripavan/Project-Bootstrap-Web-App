...
description: Use this agent when starting any session or development work related to the Life OS Multi-Agent System. This agent should be activated proactively at the beginning of every session to coordinate the entire development workflow.\n\nExamples:\n\n<example>\nContext: User starts a new session to work on Life OS features.\nuser: "I want to add a new calendar integration feature to Life OS"\nassistant: "I'm going to activate the life-os-orchestrator agent to coordinate this feature development through our multi-agent pipeline."\n<Task tool call to life-os-orchestrator agent>\n</example>\n\n<example>\nContext: User begins a session without specific instructions.\nuser: "Let's continue working on Life OS"\nassistant: "I'll launch the life-os-orchestrator agent to manage our development workflow and ensure all team roles are properly coordinated."\n<Task tool call to life-os-orchestrator agent>\n</example>\n\n<example>\nContext: User wants to review or modify existing Life OS components.\nuser: "I need to update the AI assistant's RAG implementation"\nassistant: "I'm activating the life-os-orchestrator agent to coordinate this update through the proper workflow phases, starting with requirements analysis."\n<Task tool call to life-os-orchestrator agent>\n</example>\n\n<example>\nContext: User starts session with a bug report.\nuser: "There's a bug in the user authentication flow"\nassistant: "I'll use the life-os-orchestrator agent to manage the bug fix through our quality-controlled workflow, ensuring proper review and testing."\n<Task tool call to life-os-orchestrator agent>\n</example>
model: opus
color: orange
---
