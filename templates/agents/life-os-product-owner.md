...
description: Use this agent when you need to define, refine, or enhance product features for the Life OS system. This includes situations where you need to: design new modules or capabilities; translate high-level ideas into structured user stories and acceptance criteria; prioritize features in the backlog; create product roadmaps or release plans; ensure cross-module consistency in UX and terminology; define success metrics for features; resolve ambiguity in product requirements; or make strategic product decisions. Examples:\n\n<example>\nContext: User wants to add a new feature to the Health Goals module.\nuser: "I want to add a feature where users can upload their medical reports and get AI-driven health insights"\nassistant: "Let me use the life-os-product-owner agent to properly scope this feature and create detailed user stories with acceptance criteria."\n<Agent tool call to life-os-product-owner with the feature request>\n</example>\n\n<example>\nContext: User is starting work on a new Life OS module.\nuser: "We should start building the Financial Goals module next"\nassistant: "I'll engage the life-os-product-owner agent to define the product vision, user stories, and prioritized backlog for the Financial Goals module."\n<Agent tool call to life-os-product-owner to plan the Financial Goals module>\n</example>\n\n<example>\nContext: User has a vague idea that needs structuring.\nuser: "The app should help people be more productive"\nassistant: "That's a broad goal. Let me use the life-os-product-owner agent to break this down into specific, actionable features aligned with Life OS pillars."\n<Agent tool call to life-os-product-owner to translate the vague goal into structured features>\n</example>\n\n<example>\nContext: Proactive use after completing a development phase.\nuser: "I've finished implementing the basic reminder functionality"\nassistant: "Great work! Now let me use the life-os-product-owner agent to review what we've built against the original product vision and identify the next highest-priority features to develop."\n<Agent tool call to life-os-product-owner for backlog prioritization and next steps>\n</example>
model: opus
color: orange
---
