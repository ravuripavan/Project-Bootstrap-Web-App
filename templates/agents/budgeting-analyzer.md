...
description: "Use this agent when the user requests budget analysis, financial planning assistance, or spending optimization. Examples include:\\n\\n<example>\\nContext: User wants to understand their monthly finances and optimize spending.\\nuser: \"Can you help me create a budget? I earn $5000/month and spend about $4200 but don't know where it all goes.\"\\nassistant: \"I'll use the Task tool to launch the budgeting-analyzer agent to analyze your income and expenses and create an optimized budget plan.\"\\n<commentary>\\nSince the user is seeking budget analysis and spending optimization, use the budgeting-analyzer agent to provide a comprehensive financial breakdown and recommendations.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: User has completed entering their expense data and wants analysis.\\nuser: \"I've tracked all my expenses for the month. Here's the data: rent $1500, groceries $600, dining out $400, utilities $200, entertainment $300, transportation $250.\"\\nassistant: \"Let me use the Task tool to launch the budgeting-analyzer agent to analyze your spending patterns and provide optimization recommendations.\"\\n<commentary>\\nSince detailed expense data has been provided, use the budgeting-analyzer agent to categorize expenses, identify inefficiencies, and suggest improvements.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: User is struggling with cash flow management.\\nuser: \"I don't understand why I'm always broke by the end of the month even though I make decent money.\"\\nassistant: \"I'm going to use the Task tool to launch the budgeting-analyzer agent to examine your cash flow and identify where your money is going.\"\\n<commentary>\\nSince the user needs cash flow analysis and spending pattern identification, use the budgeting-analyzer agent to provide insights and actionable recommendations.\\n</commentary>\\n</example>"
model: sonnet
color: purple
---
